...
The current public individual issuance flow supports Nigerian residents. Review [country availability](/collection/country-availability) before planning another market; underlying provider eligibility does not automatically enable that country in your Swerv account.
