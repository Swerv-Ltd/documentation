...
Stay up to date with changes to the Swervpay API, SDKs, and supported products. Entries below are historical release notes.

## August 2024

- Added the [BVN verification](/api-reference/identity/bvn) endpoint.
- Updated the [create collection](/api-reference/collections/create) endpoint to support additional information.
- Updated the Node.js SDK to support the new changes.
- Added the unfreeze card endpoint.
