...
<Note>
The current public individual USD issuance flow supports Nigerian residents. See [country availability](/collection/country-availability) for the broader provider eligibility matrix and Swerv enablement boundary.
</Note>
